...
def highlight_imperfections(image_path):
    # Read the image
    ...
    print(f"Imperfection Level: {imperfection_count}")
    return imperfection_count
    
if __name__ == "__main__":
    # Replace 'your_image_folder_path' with the path to the folder containing floor images
    ...
    for filename in os.listdir(image_folder_path):
        if filename.endswith(('.jpg', '.png', '.jpeg')):
            ...
            highlight_imperfections(image_path)
